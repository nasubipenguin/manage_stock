...
urlpatterns = [
    ...
    path('<int:stock_code>/performance/new/', views.performance_all, name='performance_all'),
    path('<int:stock_code>/performance/all/', views.performance_new, name='performance_new'),
